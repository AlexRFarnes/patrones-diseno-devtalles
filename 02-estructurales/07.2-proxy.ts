...
class User {
  private name: string;
  private role: "admin" | "user" | "editor" | "viewer";

  constructor(name: string, role: "admin" | "user" | "editor" | "viewer") {
    this.name = name;
    this.role = role;
  }
...
>>>>>>> 39c5bdfe6437dd88ffe1b6c7d069418ce4733266
  ...
  const user3 = new User("Pedro", "editor");
  const user4 = new User("Maria", "viewer");
  ...
  console.log("\nIntento de acceso del usuario 4:");
  proxy.displayContent(user4); // Debería denegar el acceso
}
